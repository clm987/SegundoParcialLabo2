...
namespace Entidades
{
    public class ProductoCocina : Producto
    {
        #region Propiedades
        ...
        {
            get { return Producto.ETipoDeProducto.Cocina; }
        }
        #endregion
        ...
        public ProductoCocina(string nombre, float precioUnitario, int cantidad, string marca, int IdProductoCocina) : base(nombre, precioUnitario, cantidad, marca, IdProductoCocina)
        {
        ...
        /// <returns></returns>
        public static bool operator ==(ProductoCocina unProductoC, ProductoCocina otroProductoC)
        {
            return (unProductoC.IdProducto == otroProductoC.IdProducto);
        }
